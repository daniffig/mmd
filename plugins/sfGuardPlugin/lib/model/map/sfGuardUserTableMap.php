...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('StockProductoSucursalRelatedByCreatedBy', 'StockProductoSucursal', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'RESTRICT', null);
    $this->addRelation('StockProductoSucursalRelatedByUpdatedBy', 'StockProductoSucursal', RelationMap::ONE_TO_MANY, array('id' => 'updated_by', ), 'RESTRICT', null);
    $this->addRelation('VentaRelatedByCreatedBy', 'Venta', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'RESTRICT', null);
    $this->addRelation('VentaRelatedByUpdatedBy', 'Venta', RelationMap::ONE_TO_MANY, array('id' => 'updated_by', ), 'RESTRICT', null);
