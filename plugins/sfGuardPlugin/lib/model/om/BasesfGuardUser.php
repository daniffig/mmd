...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array StockProductoSucursal[] Collection to store aggregation of StockProductoSucursal objects.
	 */
	protected $collStockProductoSucursalsRelatedByCreatedBy;

	/**
	 * @var        Criteria The criteria used to select the current contents of collStockProductoSucursalsRelatedByCreatedBy.
	 */
	private $lastStockProductoSucursalRelatedByCreatedByCriteria = null;

	/**
	 * @var        array StockProductoSucursal[] Collection to store aggregation of StockProductoSucursal objects.
	 */
	protected $collStockProductoSucursalsRelatedByUpdatedBy;

	/**
	 * @var        Criteria The criteria used to select the current contents of collStockProductoSucursalsRelatedByUpdatedBy.
	 */
	private $lastStockProductoSucursalRelatedByUpdatedByCriteria = null;

	/**
	 * @var        array Venta[] Collection to store aggregation of Venta objects.
	 */
	protected $collVentasRelatedByCreatedBy;

	/**
	 * @var        Criteria The criteria used to select the current contents of collVentasRelatedByCreatedBy.
	 */
	private $lastVentaRelatedByCreatedByCriteria = null;

	/**
	 * @var        array Venta[] Collection to store aggregation of Venta objects.
	 */
	protected $collVentasRelatedByUpdatedBy;

	/**
	 * @var        Criteria The criteria used to select the current contents of collVentasRelatedByUpdatedBy.
	 */
	private $lastVentaRelatedByUpdatedByCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collStockProductoSucursalsRelatedByCreatedBy = null;
			$this->lastStockProductoSucursalRelatedByCreatedByCriteria = null;

			$this->collStockProductoSucursalsRelatedByUpdatedBy = null;
			$this->lastStockProductoSucursalRelatedByUpdatedByCriteria = null;

			$this->collVentasRelatedByCreatedBy = null;
			$this->lastVentaRelatedByCreatedByCriteria = null;

			$this->collVentasRelatedByUpdatedBy = null;
			$this->lastVentaRelatedByUpdatedByCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collStockProductoSucursalsRelatedByCreatedBy !== null) {
				foreach ($this->collStockProductoSucursalsRelatedByCreatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collStockProductoSucursalsRelatedByUpdatedBy !== null) {
				foreach ($this->collStockProductoSucursalsRelatedByUpdatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collVentasRelatedByCreatedBy !== null) {
				foreach ($this->collVentasRelatedByCreatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collVentasRelatedByUpdatedBy !== null) {
				foreach ($this->collVentasRelatedByUpdatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getStockProductoSucursalsRelatedByCreatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addStockProductoSucursalRelatedByCreatedBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getStockProductoSucursalsRelatedByUpdatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addStockProductoSucursalRelatedByUpdatedBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getVentasRelatedByCreatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addVentaRelatedByCreatedBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getVentasRelatedByUpdatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addVentaRelatedByUpdatedBy($relObj->copy($deepCopy));
				}
			}
	 ...
	 */
	public function getsfGuardUserProfilesJoinSucursal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collsfGuardUserProfiles === null) {
			if ($this->isNew()) {
				...
				$this->collsfGuardUserProfiles = sfGuardUserProfilePeer::doSelectJoinSucursal($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collStockProductoSucursalsRelatedByCreatedBy collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addStockProductoSucursalsRelatedByCreatedBy()
	 */
	public function clearStockProductoSucursalsRelatedByCreatedBy()
	{
		$this->collStockProductoSucursalsRelatedByCreatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collStockProductoSucursalsRelatedByCreatedBy collection (array).
	 *
	 * By default this just sets the collStockProductoSucursalsRelatedByCreatedBy collection to an empty array (like clearcollStockProductoSucursalsRelatedByCreatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initStockProductoSucursalsRelatedByCreatedBy()
	{
		$this->collStockProductoSucursalsRelatedByCreatedBy = array();
	}

	/**
	 * Gets an array of StockProductoSucursal objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related StockProductoSucursalsRelatedByCreatedBy from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array StockProductoSucursal[]
	 * @throws     PropelException
	 */
	public function getStockProductoSucursalsRelatedByCreatedBy($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collStockProductoSucursalsRelatedByCreatedBy === null) {
			if ($this->isNew()) {
			   $this->collStockProductoSucursalsRelatedByCreatedBy = array();
				...
				$criteria->add(StockProductoSucursalPeer::CREATED_BY, $this->id);

				StockProductoSucursalPeer::addSelectColumns($criteria);
				$this->collStockProductoSucursalsRelatedByCreatedBy = StockProductoSucursalPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				StockProductoSucursalPeer::addSelectColumns($criteria);
				if (!isset($this->lastStockProductoSucursalRelatedByCreatedByCriteria) || !$this->lastStockProductoSucursalRelatedByCreatedByCriteria->equals($criteria)) {
					$this->collStockProductoSucursalsRelatedByCreatedBy = StockProductoSucursalPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastStockProductoSucursalRelatedByCreatedByCriteria = $criteria;
		return $this->collStockProductoSucursalsRelatedByCreatedBy;
	}

	/**
	 * Returns the number of related StockProductoSucursal objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related StockProductoSucursal objects.
	 * @throws     PropelException
	 */
	public function countStockProductoSucursalsRelatedByCreatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collStockProductoSucursalsRelatedByCreatedBy === null) {
			if ($this->isNew()) {
				...
				$count = StockProductoSucursalPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastStockProductoSucursalRelatedByCreatedByCriteria) || !$this->lastStockProductoSucursalRelatedByCreatedByCriteria->equals($criteria)) {
					...
					$count = count($this->collStockProductoSucursalsRelatedByCreatedBy);
				}
			} else {
				$count = count($this->collStockProductoSucursalsRelatedByCreatedBy);
			}
	...
	/**
	 * Method called to associate a StockProductoSucursal object to this object
	 * through the StockProductoSucursal foreign key attribute.
	 *
	 * @param      StockProductoSucursal $l StockProductoSucursal
	 * @return     void
	 * @throws     PropelException
	 */
	public function addStockProductoSucursalRelatedByCreatedBy(StockProductoSucursal $l)
	{
		if ($this->collStockProductoSucursalsRelatedByCreatedBy === null) {
			$this->initStockProductoSucursalsRelatedByCreatedBy();
		}
		if (!in_array($l, $this->collStockProductoSucursalsRelatedByCreatedBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collStockProductoSucursalsRelatedByCreatedBy, $l);
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related StockProductoSucursalsRelatedByCreatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getStockProductoSucursalsRelatedByCreatedByJoinProducto($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collStockProductoSucursalsRelatedByCreatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collStockProductoSucursalsRelatedByCreatedBy = StockProductoSucursalPeer::doSelectJoinProducto($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getStockProductoSucursalsRelatedByCreatedByJoinSucursal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collStockProductoSucursalsRelatedByCreatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collStockProductoSucursalsRelatedByCreatedBy = StockProductoSucursalPeer::doSelectJoinSucursal($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collStockProductoSucursalsRelatedByUpdatedBy collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addStockProductoSucursalsRelatedByUpdatedBy()
	 */
	public function clearStockProductoSucursalsRelatedByUpdatedBy()
	{
		$this->collStockProductoSucursalsRelatedByUpdatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collStockProductoSucursalsRelatedByUpdatedBy collection (array).
	 *
	 * By default this just sets the collStockProductoSucursalsRelatedByUpdatedBy collection to an empty array (like clearcollStockProductoSucursalsRelatedByUpdatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initStockProductoSucursalsRelatedByUpdatedBy()
	{
		$this->collStockProductoSucursalsRelatedByUpdatedBy = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related StockProductoSucursalsRelatedByUpdatedBy from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getStockProductoSucursalsRelatedByUpdatedBy($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collStockProductoSucursalsRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
			   $this->collStockProductoSucursalsRelatedByUpdatedBy = array();
				...
				$criteria->add(StockProductoSucursalPeer::UPDATED_BY, $this->id);

				StockProductoSucursalPeer::addSelectColumns($criteria);
				$this->collStockProductoSucursalsRelatedByUpdatedBy = StockProductoSucursalPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				StockProductoSucursalPeer::addSelectColumns($criteria);
				if (!isset($this->lastStockProductoSucursalRelatedByUpdatedByCriteria) || !$this->lastStockProductoSucursalRelatedByUpdatedByCriteria->equals($criteria)) {
					$this->collStockProductoSucursalsRelatedByUpdatedBy = StockProductoSucursalPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastStockProductoSucursalRelatedByUpdatedByCriteria = $criteria;
		return $this->collStockProductoSucursalsRelatedByUpdatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countStockProductoSucursalsRelatedByUpdatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collStockProductoSucursalsRelatedByUpdatedBy === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastStockProductoSucursalRelatedByUpdatedByCriteria) || !$this->lastStockProductoSucursalRelatedByUpdatedByCriteria->equals($criteria)) {
					...
					$count = count($this->collStockProductoSucursalsRelatedByUpdatedBy);
				}
			} else {
				$count = count($this->collStockProductoSucursalsRelatedByUpdatedBy);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addStockProductoSucursalRelatedByUpdatedBy(StockProductoSucursal $l)
	{
		if ($this->collStockProductoSucursalsRelatedByUpdatedBy === null) {
			$this->initStockProductoSucursalsRelatedByUpdatedBy();
		}
		if (!in_array($l, $this->collStockProductoSucursalsRelatedByUpdatedBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collStockProductoSucursalsRelatedByUpdatedBy, $l);
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related StockProductoSucursalsRelatedByUpdatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getStockProductoSucursalsRelatedByUpdatedByJoinProducto($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collStockProductoSucursalsRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collStockProductoSucursalsRelatedByUpdatedBy = StockProductoSucursalPeer::doSelectJoinProducto($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getStockProductoSucursalsRelatedByUpdatedByJoinSucursal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collStockProductoSucursalsRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collStockProductoSucursalsRelatedByUpdatedBy = StockProductoSucursalPeer::doSelectJoinSucursal($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collVentasRelatedByCreatedBy collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addVentasRelatedByCreatedBy()
	 */
	public function clearVentasRelatedByCreatedBy()
	{
		$this->collVentasRelatedByCreatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collVentasRelatedByCreatedBy collection (array).
	 *
	 * By default this just sets the collVentasRelatedByCreatedBy collection to an empty array (like clearcollVentasRelatedByCreatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initVentasRelatedByCreatedBy()
	{
		$this->collVentasRelatedByCreatedBy = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related VentasRelatedByCreatedBy from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getVentasRelatedByCreatedBy($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByCreatedBy === null) {
			if ($this->isNew()) {
			   $this->collVentasRelatedByCreatedBy = array();
				...
				$criteria->add(VentaPeer::CREATED_BY, $this->id);

				VentaPeer::addSelectColumns($criteria);
				$this->collVentasRelatedByCreatedBy = VentaPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				VentaPeer::addSelectColumns($criteria);
				if (!isset($this->lastVentaRelatedByCreatedByCriteria) || !$this->lastVentaRelatedByCreatedByCriteria->equals($criteria)) {
					$this->collVentasRelatedByCreatedBy = VentaPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastVentaRelatedByCreatedByCriteria = $criteria;
		return $this->collVentasRelatedByCreatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countVentasRelatedByCreatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collVentasRelatedByCreatedBy === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastVentaRelatedByCreatedByCriteria) || !$this->lastVentaRelatedByCreatedByCriteria->equals($criteria)) {
					...
					$count = count($this->collVentasRelatedByCreatedBy);
				}
			} else {
				$count = count($this->collVentasRelatedByCreatedBy);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addVentaRelatedByCreatedBy(Venta $l)
	{
		if ($this->collVentasRelatedByCreatedBy === null) {
			$this->initVentasRelatedByCreatedBy();
		}
		if (!in_array($l, $this->collVentasRelatedByCreatedBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collVentasRelatedByCreatedBy, $l);
			$l->setsfGuardUserRelatedByCreatedBy($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related VentasRelatedByCreatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getVentasRelatedByCreatedByJoinCliente($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByCreatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collVentasRelatedByCreatedBy = VentaPeer::doSelectJoinCliente($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getVentasRelatedByCreatedByJoinSucursal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByCreatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collVentasRelatedByCreatedBy = VentaPeer::doSelectJoinSucursal($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getVentasRelatedByCreatedByJoinMedioPago($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByCreatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collVentasRelatedByCreatedBy = VentaPeer::doSelectJoinMedioPago($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collVentasRelatedByUpdatedBy collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addVentasRelatedByUpdatedBy()
	 */
	public function clearVentasRelatedByUpdatedBy()
	{
		$this->collVentasRelatedByUpdatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collVentasRelatedByUpdatedBy collection (array).
	 *
	 * By default this just sets the collVentasRelatedByUpdatedBy collection to an empty array (like clearcollVentasRelatedByUpdatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initVentasRelatedByUpdatedBy()
	{
		$this->collVentasRelatedByUpdatedBy = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related VentasRelatedByUpdatedBy from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getVentasRelatedByUpdatedBy($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
			   $this->collVentasRelatedByUpdatedBy = array();
				...
				$criteria->add(VentaPeer::UPDATED_BY, $this->id);

				VentaPeer::addSelectColumns($criteria);
				$this->collVentasRelatedByUpdatedBy = VentaPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				VentaPeer::addSelectColumns($criteria);
				if (!isset($this->lastVentaRelatedByUpdatedByCriteria) || !$this->lastVentaRelatedByUpdatedByCriteria->equals($criteria)) {
					$this->collVentasRelatedByUpdatedBy = VentaPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastVentaRelatedByUpdatedByCriteria = $criteria;
		return $this->collVentasRelatedByUpdatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countVentasRelatedByUpdatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collVentasRelatedByUpdatedBy === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastVentaRelatedByUpdatedByCriteria) || !$this->lastVentaRelatedByUpdatedByCriteria->equals($criteria)) {
					...
					$count = count($this->collVentasRelatedByUpdatedBy);
				}
			} else {
				$count = count($this->collVentasRelatedByUpdatedBy);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addVentaRelatedByUpdatedBy(Venta $l)
	{
		if ($this->collVentasRelatedByUpdatedBy === null) {
			$this->initVentasRelatedByUpdatedBy();
		}
		if (!in_array($l, $this->collVentasRelatedByUpdatedBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collVentasRelatedByUpdatedBy, $l);
			$l->setsfGuardUserRelatedByUpdatedBy($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related VentasRelatedByUpdatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getVentasRelatedByUpdatedByJoinCliente($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collVentasRelatedByUpdatedBy = VentaPeer::doSelectJoinCliente($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getVentasRelatedByUpdatedByJoinSucursal($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collVentasRelatedByUpdatedBy = VentaPeer::doSelectJoinSucursal($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getVentasRelatedByUpdatedByJoinMedioPago($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collVentasRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
				...
				$this->collVentasRelatedByUpdatedBy = VentaPeer::doSelectJoinMedioPago($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collStockProductoSucursalsRelatedByCreatedBy) {
				foreach ((array) $this->collStockProductoSucursalsRelatedByCreatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collStockProductoSucursalsRelatedByUpdatedBy) {
				foreach ((array) $this->collStockProductoSucursalsRelatedByUpdatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collVentasRelatedByCreatedBy) {
				foreach ((array) $this->collVentasRelatedByCreatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collVentasRelatedByUpdatedBy) {
				foreach ((array) $this->collVentasRelatedByUpdatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
