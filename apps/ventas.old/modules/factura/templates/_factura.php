...
<?php
  ...
  {
    $factura->setNroFactura(rand(20000, 50000));
    $factura->save();
  }
?>
<table id="HeaderFactura">
  ...
  <tr>
  	<td align="center"><img src="lightbulb_icon.jpg" /></td>
		<td></td>
		<td align="center">Nº <?php echo '000' . $sucursal->getId() . '-' .$factura->getNroFactura(); ?></td>
  </tr>
	<tr>
	...
	<tr>
		<td align="center" class="datosEmpresa">Télefono: <?php echo Preferencia::get('empresa_telefono'); ?></td>
		<td></td>
