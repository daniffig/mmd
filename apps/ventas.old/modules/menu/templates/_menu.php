        ...
        <ul class="nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><?php  echo link_to(__("<i class='icon-th-list'></i> Ver Ventas"), 'venta/verVentas'); ?></li>
              <?php endif; ?>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><?php  echo link_to(__("<i class='icon-th-list'></i> Ver Usuarios"), 'usuario/verUsuarios'); ?></li>
